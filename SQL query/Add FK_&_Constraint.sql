...
ADD 
    ...
    CONSTRAINT FK_CUNGCAP_KHO FOREIGN KEY (ID_Kho) REFERENCES KHO(ID);
...
ADD 
    ...
    CONSTRAINT FK_KIEMKE_KHO FOREIGN KEY (ID_Kho) REFERENCES KHO(ID);

ALTER TABLE CHUA 
ADD
    CONSTRAINT FK_CHUA_KHO FOREIGN KEY (ID_Kho) REFERENCES KHO(ID),
    CONSTRAINT FK_CHUA_NGUYENLIEU FOREIGN KEY (ID_NguyenLieu) REFERENCES NGUYENLIEU(ID);
